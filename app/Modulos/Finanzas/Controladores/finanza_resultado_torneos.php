...
try {
    ...
    $payload = [
        ...
        'integral' => $integral,
        'estado_asociacion' => null,
        'tasa_eur_bs' => FinanzaFvd::obtenerTasaEurBs($pdo),
        'torneos_estructurado' => InformeFvd::torneosSelectorEstructurado($pdo),
        'nota_ingresos' => 'Ingresos = nómina por movimientos (indicador = 1) × tarifas vigentes en €.',
        'nota_gastos' => 'Gastos = costos operativos registrados del torneo.',
    ];
    ...
    if ($torneoId > 0) {
        ...
        $det = InformeFvd::resultadoFinancieroDetalleTorneo($pdo, $torneoId, $soloAsoc);
        ...
        $listado = InformeFvd::resultadoFinancieroFilasPorTorneo($pdo, $gid, $soloAsoc);
    ...
    error_log('finanza_resultado_torneos: ' . $e->getMessage());
